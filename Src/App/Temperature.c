...
static WORD s_dwProcessedData_STD[MAX_PAST_DATA][2];
...
void Temperature_RoutineService(void)
{
    ...
    /*Humidity*/
    s_dwProcessedData_STD[s_byCurrentDataSeq][0] = (((s_byRawData_DHT20[1] << 12) | (s_byRawData_DHT20[2] << 4) | (s_byRawData_DHT20[3] >> 4)) * 100) / 1048576;
    
    /*Temperature*/
    s_dwProcessedData_STD[s_byCurrentDataSeq][1] = (((((s_byRawData_DHT20[3] & 0b00001111) << 16) | (s_byRawData_DHT20[4] << 8) | (s_byRawData_DHT20[5])) * 200) / 1048576)- 50;
